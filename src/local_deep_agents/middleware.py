...
from local_deep_agents.states import PlanningState, FilesystemState
...
from local_deep_agents.subagent_types import SubAgent, CustomSubAgent

#####
# 👉 All middlewares conform AgentMiddleware protocol
#####
...
def create_task_tool(
    ...
    sub_agents_string = _get_subagent_description(subagents)

    if is_async:

        @tool(description=TASK_TOOL_DESCRIPTION.format(sub_agents=sub_agents_string))
        async def task(
            description: str,
            subagent_type: str,
